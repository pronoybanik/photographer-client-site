    ...
    return (
        <div id= {`slide${id}`} className="carousel-item relative w-full ">
                    ...
                    <div className="absolute flex justify-end transform  w-1/2 -translate-y-1/2 left-5  top-2/4">
                        <p className='text-white mt-24 lg:text-xl text-xs w-full ' > If you find that your favorite music or your best-loved movie director no longer stirs your imagination, it’s time to turn your attention to the all-time classics: the famous photographers that shook the world. </p>
                    </div>
